...
```{r include=FALSE}
C <- readRDS(here::here("data", "demog", "demog_recode_example.Rds"))
```
...
1.	Who in your home smokes? (*check all that apply*) W1BIQ1, W1FamSmoke1, 0 When Not Selected, 1 When Selected

No one smokes in my home W1BIQ1option1 W1FamSmokeNoOne1
`r colorize("W1BIQ1option1", "blue")` `r colorize("W1FamSmokeNoOne1", "red")`

I am the only one who smokes in my home W1BIQ1option2 W1FamSmokeOnlyMe1
`r colorize("W1BIQ1option2", "blue")` `r colorize("W1FamSmokeOnlyMe1", "red")`

Father (Male Guardian) W1BIQ1option3 W1FamSmokeDad1
`r colorize("W1BIQ1option3", "blue")` `r colorize("W1FamSmokeDad1", "red")`

Mother (Female Guardian) W1BIQ1option4 W1FamSmokeMom1
`r colorize("W1BIQ1option4", "blue")` `r colorize("W1FamSmokeMom1", "red")`

Older Brother W1BIQ1option5 W1FamSmokeOldBro1
`r colorize("W1BIQ1option5", "blue")` `r colorize("W1FamSmokeOldBro1", "red")`

Older Sister W1BIQ1option6 W1FamSmokeOldSis1
`r colorize("W1BIQ1option6", "blue")` `r colorize("", "red")`

Younger Brother W1BIQ1option7 W1FamSmokeYoungBro1
`r colorize("W1BIQ1option7", "blue")` `r colorize("", "red")`

Younger Sister W1BIQ1option8 W1FamSmokeYoungSis1
`r colorize("W1BIQ1option8", "blue")` `r colorize("", "red")`

Grandmother / Grandfather W1BIQ1option9 W1FamSmokeGrandparent1
`r colorize("W1BIQ1option9", "blue")` `r colorize("", "red")`

Other (please specify) W1BIQ1option10 W1FamSmokeOther1 ____________ `r colorize("W1BIQ1option10", "blue")` `r colorize("", "red")`

W1BIQ1other W1FamSmokeOtherSpecify1
